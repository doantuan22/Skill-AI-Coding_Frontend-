...
Suites: `SMOKE = E01,E02,E06,E08,E12`; `CORE = E01–E12`; `EXECUTION = E21–E28`; `RUNTIME = E29–E36`; `ACCESSIBILITY = E37–E44`; `VISUAL_LANGUAGE = E45–E52`; `INSPIRATION = E53–E64`; `FULL = E01–E64`. Any hardening/routing/contract change must rerun at least SMOKE; execution-layer changes rerun EXECUTION; runner/storage changes rerun RUNTIME; visual-language changes rerun VISUAL_LANGUAGE; inspiration/typography/motion/pattern changes rerun INSPIRATION and VISUAL_LANGUAGE; broad changes rerun FULL.
