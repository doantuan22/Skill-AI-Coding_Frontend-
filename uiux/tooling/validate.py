...
PLUGIN_READY_FILES = {
    "VERSION", "CHANGELOG.md", "docs/plugin-architecture.md",
    ...
    "uiux/tooling/validate.py", "phase-2/knowledge/registry.json",
...
PLUGIN_LAYER_FILES = {
    "plugin/README.md", "plugin/manifest/plugin.json", "plugin/manifest/README.md", "plugin/manifest/plugin.schema.json",
    "plugin/adapters/README.md", "plugin/adapters/CONTRACT.md", "plugin/adapters/generic/adapter.py",
    "plugin/adapters/generic/README.md", "plugin/adapters/mcp/__init__.py", "plugin/adapters/mcp/protocol.py",
    "plugin/adapters/mcp/server.py", "plugin/adapters/mcp/adapter.json", "plugin/adapters/mcp/README.md",
    "plugin/packaging/README.md", "plugin/packaging/package-rules.json",
    "plugin/packaging/package_files.py", "plugin/packaging/artifact.py", "plugin/packaging/build.py",
    "plugin/packaging/verify.py", "plugin/schemas/README.md", "plugin/schemas/package-manifest.schema.json",
    "plugin/schemas/build-info.schema.json", "plugin/schemas/adapter.schema.json", "plugin/adapters/generic/adapter.json",
}
...
def plugin_ready_checks(root: Path) -> list[str]:
    ...
    try:
        ...
        if (root / "plugin/manifest/plugin.json").is_file():
            manifest = json.loads(text(root / "plugin/manifest/plugin.json"))
        ...
        if (root / "plugin/manifest/plugin.json").is_file():
            declared = sorted(json.loads(text(root / "plugin/manifest/plugin.json")).get("capabilities", []))
