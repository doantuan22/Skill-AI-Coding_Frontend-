...
Owner of temporal behavior (see [Motion Engine](../phase-2/motion/README.md)). Duration and easing **values** live in `DESIGN-TOKENS.md`; this file references token names. Low-budget app work may record only the `motion_character` block inside `VISUAL-GRAMMAR.md`.
