...
For screen types without a Phase 1 reference (e.g., AI copilot, kanban, calendar, file browser), the `anatomy`, `hierarchy`, `primary_actions` and `states` fields of the [screen library../../knowledge/domains/screens/README.md may be consulted read-only as a checklist. Phase 1 still decides and locks the structure.
