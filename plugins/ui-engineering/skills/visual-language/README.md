...
Component grammars are indexed in [../../knowledge/visual-language/components/README.md](../../knowledge/visual-language/components/README.md). Use [craft-review.md](craft-review.md) before browser QA and [adversarial-review.md](adversarial-review.md) for redesigns or suspected generic output.
