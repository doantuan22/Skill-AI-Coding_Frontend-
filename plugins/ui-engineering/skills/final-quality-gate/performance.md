...
For motion, apply [motion performance safety](../motion/performance-safety.md) and flag `SCROLL_JANK_RISK`; for effects, interactions and graphics, check the [performance budget](../05-frontend-implementation/performance-budget.md).
